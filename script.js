const tree = {
    ...
    rsoh_success: {
        text: "Ты имеешь право поступить без вступительных испытаний и стать БВИ по соответствующему направлению подготовки. Необходимо подтвердить результат олимпиады баллами ЕГЭ (не менее 75 баллов по профильному предмету подготовки).",
        answers: {}
    },
    ...
    vsoh_success: {
        text: "Ты имеешь право поступить без вступительных испытаний и стать БВИ по соответствующему направлению подготовки. Подтверждать результат олимпиады баллами ЕГЭ не требуется.",
        answers: {}
    },
